...
function getDagDepths (_ref, idAccessor) {
  ...
  function traverseDepthFirst(nodes) {
    ...
    for (var i = 0, l = nodes.length; i < l; i++) {
      ...
      if (currentDepth > node.depth) {
        ...
        traverseDepthFirst(node.out, [].concat(_toConsumableArray(nodeStack), [node]), currentDepth + (node.skip ? 0 : 1));
      }
    }
  }
  ...
  function traverseBreadthFirst(nodes) {
    ...
    for (var i = 0, l = nodes.length; i < l; i++) {
      ...
      traverseBreadthFirst(node.out, [].concat(_toConsumableArray(nodeStack), [node]), currentDepth + (node.skip ? 0 : 1));
    }
  }
