...
(function (global, factory) {
  ...
  **/
  ...
  function getDagDepths (_ref, idAccessor) {
    ...
    var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      ...
      throw "Invalid DAG structure! Found cycle in node path: ".concat(loopIds.join(' -> '), ".");
        ...
        _ref2$dagNodeSortingO = _ref2.dagNodeSortingOrder,
        dagNodeSortingOrder = _ref2$dagNodeSortingO === void 0 ? 'depthFirst' : _ref2$dagNodeSortingO;

    // linked graph
    var graph = {};
    var rootCandidates = {};
    nodes.forEach(function (node) {
      var nodeId = idAccessor(node);
      graph[nodeId] = {
        data: node,
        out: [],
        depth: -1,
    ...
    var foundLoops = [];
    var rootNodes = Object.values(rootCandidates);
    ...
    if (dagNodeSortingOrder == 'depthFirst') {
      ...
      throw "Unsupported dagNodeSortingOrder: ".concat(dagNodeSortingOrder);
    }
    ...
    function traverseDepthFirst(nodes) {
      ...
      for (var i = 0, l = nodes.length; i < l; i++) {
        ...
        if (currentDepth > node.depth) {
          ...
          traverseDepthFirst(node.out, [].concat(_toConsumableArray$2(nodeStack), [node]), currentDepth + (node.skip ? 0 : 1));
        }
      }
    }

    function traverseBreadthFirst(nodes) {
      var nodeStack = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
      var currentDepth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
      ...
      for (var i = 0, l = nodes.length; i < l; i++) {
        ...
        traverseBreadthFirst(node.out, [].concat(_toConsumableArray$2(nodeStack), [node]), currentDepth + (node.skip ? 0 : 1));
      }
    }
  ...
  var linkedProps = Object.assign.apply(Object, _toConsumableArray$2(['nodeColor', 'nodeAutoColorBy', 'nodeCanvasObject', 'nodeCanvasObjectMode', 'linkColor', 'linkAutoColorBy', 'linkLineDash', 'linkWidth', 'linkCanvasObject', 'linkCanvasObjectMode', 'linkDirectionalArrowLength', 'linkDirectionalArrowColor', 'linkDirectionalArrowRelPos', 'linkDirectionalParticles', 'linkDirectionalParticleSpeed', 'linkDirectionalParticleWidth', 'linkDirectionalParticleColor', 'dagMode', 'dagNodeSortingOrder', 'dagLevelDistance', 'dagNodeFilter', 'onDagError', 'd3AlphaMin', 'd3AlphaDecay', 'd3VelocityDecay', 'warmupTicks', 'cooldownTicks', 'cooldownTime', 'onEngineTick', 'onEngineStop'].map(function (p) {
